...
- Full-length papers must be submitted as Microsoft Word documents.
- The official template is a Word `.docx` file and should be used for formatting.
- Standard full papers are limited to 15 pages including all material except the cover page.
...
| Item | Official template value | Manuscript value after update |
|---|---:|---:|
| Page size | US Letter, 8.5 x 11 in | US Letter, 8.5 x 11 in |
| Top margin | 0.50 in | 0.50 in |
| Bottom margin | 0.56 in | 0.56 in |
| Left margin | 1.00 in | 1.00 in |
| Right margin | 1.00 in | 1.00 in |
| Normal font | Arial 11 pt | Arial 11 pt |
| Title font | Arial Bold 16 pt | Arial Bold 16 pt |
| Heading 1 | 14 pt, bold | 14 pt, bold |
...
1. Page count is 15 pages or fewer excluding the cover page.
2. Figures do not overflow margins after Word pagination.
3. Tables remain readable at final scale.
4. All author names, affiliations, conference metadata, and corresponding-author details are finalized.
5. Any appendix or expanded ablation material is moved outside the main 15-page body if needed.
